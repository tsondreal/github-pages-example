...
const LightMenuBar = () => {
  ...
  return (
    <div className="sticky top-0 w-full backdrop-blur flex-none transition-colors duration-500 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-white/95 supports-backdrop-blur:bg-white/60 dark:bg-transparent">
...
<Typography
          ...
          >
          <img src={logo} className="App-menu-logo" alt="logo" />&nbsp;&nbsp;GetTech
          </Typography>
*/